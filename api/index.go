...
func buildApp() (http.Handler, error) {
...
func isPublicDomain(host string) bool {
	publicDomains := []string{
		...
		"prospeccao-brasil.vercel.app",
		"prospeccao-brasil-joppe-solutions.vercel.app",
		"prospeccao-brasil-git-main-joppe-solutions.vercel.app",
	}
